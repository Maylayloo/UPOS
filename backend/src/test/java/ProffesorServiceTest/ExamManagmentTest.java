...
class ExamManagementForProfessorServiceTest {
    ...
    void testScheduleExam() {
        ...
        Course course = new Course(8L,"Anal", 5, 2L, "1", "Math",studentsId);
        Exam exam = new Exam(2L, 1L, 2L, "2025-01-10", "D5-s101", "1");
    ...
    void testModifyExamById() {
        ...
        Long examId = 3L;
        List<Long> studentsId = new ArrayList<Long>(Arrays.asList(1L, 2L));
        Course course = new Course(6L,"Math", 5, 2L, "2", "AiR",studentsId);
        Exam oldExam = new Exam(3L,1L,2L, "2025-01-10", "Room 101","1");
    ...
    void testModifyExamById_ExamNotFound() {
        ...
        List<Long> studentsId = new ArrayList<Long>(Arrays.asList(1L, 2L));
        Course course = new Course(7L,"Math", 5, 1L, "3", "Mathematics",studentsId);
        course.addExam(new Exam(6L,1L,1L, "2025-01-10", "Room 101","2"));
        Exam updatedExam = new Exam(7L,2L,1L, "2025-02-15", "Room 202","2");
