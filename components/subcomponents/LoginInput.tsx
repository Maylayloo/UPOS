...
const LoginInput = ({type, name, image, alt}: loginInputProps) => {
    return (
        <div className='border border-[#CED4DA] flex rounded-[0.5rem] mb-4 w-[125%]'>
            ...
            <input type={type} name={name} className='w-full px-4 rounded-r-[0.5rem] text-[#19191a] focus:outline-none focus:border-cyan-300 focus:border focus:shadow-2xl'/>
        </div>
    );
};
